  ...
  const features: Feature[] = [
    {
      ...
      description: 'Tailored design approaches that transform spaces with personalized style and functional excellence.'
    },
    {
      icon: Users,
      title: 'Expert Team',
              ...
              <div className="relative aspect-video bg-gray-700/30 rounded-xl overflow-hidden">
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="text-center p-8">
                    ...
                    <p className="text-gray-300">Transforming spaces with innovative design and impeccable craftsmanship</p>
                  </div>
                </div>
              </div>
            </div>
